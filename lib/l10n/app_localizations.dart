...
abstract class AppLocalizations {
  ...
  /// Scroll direction setting label
  ///
  /// In en, this message translates to:
  /// **'Scroll Direction'**
  String get scrollDirection;

  /// Top to bottom scroll direction option
  ///
  /// In en, this message translates to:
  /// **'Top to Bottom'**
  String get topToBottom;

  /// Bottom to top scroll direction option
  ///
  /// In en, this message translates to:
  /// **'Bottom to Top'**
  String get bottomToTop;

  /// Description for top to bottom scroll direction
  ///
  /// In en, this message translates to:
  /// **'Live captions at top, newest segments at bottom'**
  String get topToBottomDescription;

  /// Description for bottom to top scroll direction
  ///
  /// In en, this message translates to:
